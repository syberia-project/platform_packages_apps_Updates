...
import com.syberia.ota.UpdaterApplication;
import com.syberia.ota.activities.UpdaterActivity;
import com.syberia.ota.misc.Constants;
import com.syberia.ota.misc.State;
import com.syberia.ota.misc.UpdateInfo;
import com.syberia.ota.requests.UpdatesJsonObjectRequest;
import com.syberia.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.syberia.ota.action.UPDATE_CHECK_FINISHED";
